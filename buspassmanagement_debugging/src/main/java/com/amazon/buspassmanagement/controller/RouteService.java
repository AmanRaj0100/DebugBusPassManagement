...
public class RouteService {
	...
	public void deleteRoute() {
		...
		buspass.routeId = route.id;
		int result1 = vehicleDAO.delete(vehicle);
		int result2 = stopDAO.delete(stop);
		int result3 = routeDAO.delete(route);
		String sql = "DELETE FROM BusPass WHERE routeId = "+buspass.routeId;
		int result4 = db.executeSQL(sql);
		String message4 = (result4 > 0) ? "BusPass Deleted Successfully" : "Deleting BusPass Failed. Try Again.."; 
		System.out.println(message4);
		String message1 = (result1 > 0) ? "Vehicle Deleted Successfully" : "Deleting Vehicle Failed. Try Again.."; 
		System.out.println(message1);
		String message2 = (result2 > 0) ? "Stops Deleted Successfully" : "Deleting Stops Failed. Try Again.."; 
		System.out.println(message2);
		String message3 = (result3 > 0) ? "Route Deleted Successfully" : "Deleting Route Failed. Try Again.."; 
